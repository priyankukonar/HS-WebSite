   ...
   return (
      <>
         <div className="flex items-center share-btn">
            ...
            <div className={`${activeTab ? 'is-opened' : 'is-closed'} ml-6 grid grid-cols-5 gap-3 justify-center text-center text-sm text-gray-500 border border-gray-400 rounded-md px-2 py-1`}>
