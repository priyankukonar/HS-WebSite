   ...
   return (
      <Section className="bg-green-100">
         <Section.Container className="container mx-auto py-8 md:py-16 px-2">
            <h2 className="text-3xl font-medium text-blue-900 mb-12">
            ...
            <div className="bg-white rounded-xl shadow-lg max-w-6xl mx-auto mt-4">
               ...
               <div className="flex flex-wrap items-center bg-gradient-to-r from-customGreen to-customBlue1 rounded-b-xl p-6 md:p-8">
                  {data1?.map((dat) => (
