         ...
         <Section.Container className="mx-auto ">
            <div className="flex flex-col-reverse md:flex-row items-center justify-center px-2 md:px-0">
               <div className="p-4 md:p-0 md:w-7/12">
                  <img
                     src="/assets/diagnotician-image.png"
                     className="w-full"
                  />
               </div>
                     ...
                     <ContactFormProvider
                        renderTrigger={(rprops) => (
                           <>
                              <a
                                 {...rprops}
                                 className="btn-secondary opacity-50 cursor-pointer"
                              >
                                 {"KNOW MORE"}
                              </a>
                           </>
      ...
      <StyledHome settings={settings}>
         ...
         <Section className="bg-gray-100">
            <Section.Container className="container mx-auto py-12 md:py-20">
               ...
               <p className="text-center mb-4 text-muted font-bold">
               ...
               <div className="grid md:grid-cols-3 gap-4 mt-8 md:mt-16 mx-auto md:w-6/12 ">
                  <div className="grid__col">
                     <div className="flex gap-2 items-center md:items-start">
                        <div>
                           <img
                              src="/assets/diagnostician-icon1.png"
                              className="w-10 h-10"
                           />
                        </div>
                  ...
                  <div className="grid__col">
                     <div className="flex gap-2 items-center md:items-start">
                        <div>
                           <img
                              src="/assets/diagnostician-icon2.png"
                              className="w-10 h-10"
                           />
                        </div>
                        <div className="flex-1">
                  ...
                  <div className="grid__col md:ml-5">
                     <div className="flex gap-2 items-center md:items-start">
                        <div>
                           <img
                              src="/assets/diagnostician-icon3.png"
                              className="w-10 h-10"
                           />
                        </div>
                        <div className="flex-1">
         ...
         <Section className=" bg-blue-800 text-white">
            <Section.Container className="container mx-auto py-12 md:py-20">
               ...
               <p className="text-white text-center text-sm">
                  HaystackAnalytics enables you to get started with genomics,{" "}
                  <br />
               ...
               <div className="flex flex-col md:flex-row items-center justify-center gap-4 my-8">
                  <button
                     ...
                     className={`border-2 border-white px-4 py-2 text-white hover:bg-white hover:text-customBlue1 cursor-pointer font-bold ${
                        activeTab == "1"
                           ? "active bg-white text-customBlue1"
                           : ""
                     }`}
                  >
                     One click reporting
         ...
         <Section className="SectionGridItems bg-blue-800 text-white ">
            <Section.Container className="container mx-auto py-12 md:py-24 text-center">
               <h3
                  className={`text-white section-heading section-heading--invert `}
               >
                  {"Why Partner With Us"}
               </h3>
               <div className="flex flex-col md:flex-row items-center gap-6 my-6 justify-center">
                  <button
                     ...
                     className={`text-white font-bold px-4 py-3 border-2 border-white ${
                        activeTab2 == "4"
                           ? "active bg-white text-customBlue1"
                           : ""
                     }`}
                  >{`I have a sequencer`}</button>
                  <button
                     type="button"
                  ...
                  >{`I don't have a sequencer`}</button>
               </div>
               <div className="md:px-16 md:max-w-xl mx-auto text-left">
                  {activeTab2 == "4" && (
                     <div data-aos="zoom-in">
                        {`If you own a sequencer, HaystackAnalytics's bioinformatics platform is compatible with illumina, nanopore & BGI platforms.`}
                        <br />
                        Connect with us to get access to several pre-validated
                        clinical genomics applications.
                     </div>
                  )}
                  {activeTab2 == "5" && (
                     <div data-aos="zoom-in">
                        At HaystackAnalytics we have clinical apps for
                        infectious diagnostics, built on nanopore platform which
                        can be easily integrated into your lab with less than
                        $10k of Capex. <br />
                        Connect with us to get access to our nanopore based
                        <br />
